...
function dataconfig(datac,  a,i,s,sn,jsona,configfp,language,site,status,countofsites,desc,source,header) {
  ...
  desc   = "Configuration data for Template:Numberof - This page is generated automatically manual changes will be overwritten."
  source = "Generated by https://github.com/greencardamom/Numberof"
  ...
  if(G["doupload"])
      upload(readfile(datac), "Data:Wikipedia statistics/config.tab", "Update statistics", G["home"] "log", BotName, "commons", "wikimedia")
